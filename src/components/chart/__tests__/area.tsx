...
/**
 * Factory function to create a ShallowWrapper for the Area component.
 * @function setup
 *
 ...
 */
const setup = (props: AreaProps = defaultProps): ShallowWrapper => {
    return shallow(<Area {...props} />);
};
...
describe("render", () => {
    const testCases: TestCase[] = [
        {
            name: 'component',
            element: 'component-area'
        },
        {
            name: 'linear gradient element',
            element: 'liner-gradient-element'
        },
        {
            name: 'path element',
